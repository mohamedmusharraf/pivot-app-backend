...
class ResearchRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        if ($this->isMethod('post')) {
            return [
                ...
                'files' => 'nullable|file|mimes:pdf,doc,docx|max:1048576',
        ...
        return [
            ...
            'files' => 'sometimes|nullable|file|mimes:pdf,doc,docx|max:1048576',
    ...
    public function messages(): array
    {
        return [
            ...
            'files.max' => 'Files must not be greater than 1 GB.',
        ];
    }
}
